...
//        this.percentage = productDto.getPercentage();
//        this.category = category;
//    }
//
//    public Product(String name, String imageURL, double price, double percentage, String description, Category category) {
//        super();
//        this.name = name;
